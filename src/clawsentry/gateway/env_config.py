...
CONFIG_FIELDS: tuple[ConfigField, ...] = (
    ...
    ConfigField("skill_trust.first_use_normal_action", "CS_SKILL_TRUST_FIRST_USE_NORMAL_ACTION", "audit", str, "skill_trust", "First-use Skill Trust action in normal mode"),
